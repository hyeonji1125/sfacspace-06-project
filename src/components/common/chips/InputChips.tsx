...
function InputChips({inputType, wid, hei, children}: {inputType: InputChipsType, wid : string, hei : string, children: ReactNode}) {
    ...
    >
      ...
      {inputType !== 'textOnly' && (
        <div className="flex items-center w-[20px] h-[20px] flex-shrink-0">
          <Image alt="파일이미지" width={40} height={20} src="/assets/images/chipsIcon.png"/>
        </div>
      )}
      {/* 칠드런 박스 */}
