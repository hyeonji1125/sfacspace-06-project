...
export default function Button({
  ...
  const sizes = {
    ...
    small:
      "px-3 md:px-5 py-1 md:py-2 text-base sm:text-lg md:text-xl font-light",
  };

  return (
    <button
      className={twMerge(
        "flex items-center justify-center whitespace-nowrap rounded-lg px-10 py-3 text-lg font-semibold hover:shadow-lg disabled:hover:shadow-none sm:text-xl md:px-14 md:py-4 md:text-2xl",
        themes[theme],
        size && sizes[size],
