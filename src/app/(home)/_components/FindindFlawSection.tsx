      ...
      <div className="flex h-[800px] w-full max-w-[1920px] overflow-hidden md:h-[900px] xl:h-[1020px]">
        <div className="relative flex w-full flex-col items-center px-[10%] py-20 xl:flex-row xl:py-0">
          <div className="flex flex-col gap-[60px] text-center xl:text-left">
            <h1 className="flex flex-col gap-5 text-4xl font-bold leading-tight text-primary-purple-500 sm:text-5xl md:text-6xl xl:gap-8 2xl:text-[80px]">
              <p>쉽고 편하게</p>
              <p>취약점을 발견하다</p>
            </h1>
            <div className="flex flex-col gap-4 xl:gap-7">
              <div className="flex flex-col gap-2 text-xl font-bold text-custom-text-footer-black dark:text-custom-dark-text sm:text-2xl md:text-3xl xl:gap-3 xl:text-[32px]">
                <p>코드 보안</p>
                <p>어떻게 관리하시나요?</p>
              </div>
              <div className="flex flex-col gap-1 text-sm font-medium text-text-gray-default sm:text-base md:text-lg xl:gap-2 xl:text-xl">
